...
class createwizardparent(models.TransientModel):
    ...
    file_type = fields.Selection([('csv', 'CSV'), ('xls', 'XLS')], string='Choose the file Type', default='csv', required=True)

    res_model = fields.Selection([('explo.explo','Exploitation'), ('invest.invest','Invest'),('achat.achat','Achat')],string='Model', required=True)
    ...
    def import_file(self):
        ...
        elif self.res_model == 'invest.invest':
            table = 'invest_invest'
            importable_fields = {
                'champs1': 'code', 
                'champs2': 'rubriques', 
                'champs3': 'report_et_anterieurs',
                'champs4': 'nouveaux_credits',
                'champs5': 'total_credits',
                'champs6': 'credits_dengagement'
                }
        else:
            table = 'achat_achat'
            importable_fields = {
